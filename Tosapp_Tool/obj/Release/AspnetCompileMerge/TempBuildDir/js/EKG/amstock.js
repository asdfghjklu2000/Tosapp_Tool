(function () {
    ...
    e.AmStockChart = e.Class({
        construct: function (a) {
            ...
            if (a >= q && a < l) return f;
            if (!(1 >= k - d)) return a <
                q ? this.getEventDataItem(a, b, c, d, n, g) : this.getEventDataItem(a, b, c, n, k, g)
            ...
            for (c = 0; c < b.length; c++) d =
                b[c], d.hideDrawingIcons && ("never" != d.recalculateToPercents && 0 < a.length ? d.hideDrawingIcons(!0) : d.drawingIconsEnabled && d.hideDrawingIcons(!1))
        }, addPanel: function (a) {
            this.panels.push(a);
            this.prevPH = void 0;
            e.removeChart(a);
